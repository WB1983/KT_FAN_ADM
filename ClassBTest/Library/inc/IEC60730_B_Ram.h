...
#ifndef __IEC60730_RAM_H
#define __IEC60730_RAM_H
...
ErrorStatus IEC60730_B_StartupMarch(uint32_t startadd,uint32_t endadd,uint32_t MCU_endadd);
ErrorStatus IEC60730_B_StartupMarch_VA5(uint32_t startadd,uint32_t endadd,uint32_t MCU_endadd);
#endif /* __IEC60730_RAM_H */
