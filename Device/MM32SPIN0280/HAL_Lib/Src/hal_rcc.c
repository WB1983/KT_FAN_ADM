...
const u8 tbPresc[] = {0, 0, 0, 0, 1, 2, 3, 4, 1, 2, 3, 4, 6, 7, 8, 9};
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void RCC_HSEConfig(RCCHSE_TypeDef hsesource)
{
...
{
    u32 result;
    u32 clock, mul, div,pdiv;
    switch (RCC->CFGR & RCC_CFGR_SWS) {

        case RCC_CFGR_SWS_HSE:                                  //HSE without pll
            result = HSE_VALUE;                     
            break;
        case RCC_CFGR_SWS_PLL:                                  //PLL
            ...
            pdiv= ((RCC->PLLCFGR & RCC_PLLCFGR_PLL_DM) >> RCC_PLLCFGR_PLL_DM_Pos) + 1;

            result = clock * mul /div/pdiv;
            break;
        case RCC_CFGR_SWS_LSI:
            result = LSI_VALUE;
            break;
        default:                                                //HSI
            result =  HSI_SYSCLKSRC_VALUE;              //8mhz
            break;
    }
    return result;
}
